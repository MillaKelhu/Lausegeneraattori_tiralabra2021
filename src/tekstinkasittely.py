...
def tekstin_siivous(teksti: str, kaikki_lauseet_virkkeiksi: bool = False):
    """Funktio, joka siivoaa annetun tekstin erikoismerkeistä,
    erottelee virkkeet toisistaan merkillä '$' ja muuttaa samalla
    kaikki isot kirjaimet pieniksi. Tämä on tekstin trieen tallentamista varten.
